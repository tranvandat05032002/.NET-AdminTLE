...
namespace SV21T1020285.BusinessLayers
{
    public static class OrderDataService
    {
        ...
        public static List<Order> ListOrdersCustomer(int customerID, out int rowCount, int page = 1, int pageSize = 0,
        int status = 0, DateTime? fromTime = null, DateTime? toTime = null,
        ...
        string searchValue = "")
        {
            ...
            rowCount = orderDB.Count(status, fromTime, toTime, searchValue);
            return orderDB.List(customerID, page, pageSize, status, fromTime, toTime, searchValue).ToList();
        }
        /// <summary>
